Adicione os seguintes projetos ao portfólio:

ModestoLabs:
Link produção: https://modestolabs.up.railway.app/

Site institucional da minha empresa (laboratório de SaaS).

Use o texto para criar uma descrição:

A ModestoLabs cria produtos SaaS para nichos específicos — simples por fora, sólidos por dentro. Cada linha de código tem um propósito.

Giraa - Landing Page

https://giraa-landing-page.up.railway.app/ 

Landing page apresentando um produto SaaS real (produto do ModestoLabs).

Use o texto para criar um descrição:
'Seu salão lotado.
Sua gestão simples.
Agendamentos automáticos, controle de clientes e relatórios — tudo num só app.

Por que o Giraa?
Tudo que você precisa para gerir seu salão ou barbearia, em um único lugar. Simples, rápido, feito para quem trabalha no dia a dia.

Agendamento online 24h pelo cliente
...
Link github: https://github.com/LuisFelipeMod/salao-leila
Link demo: https://salao-leila.up.railway.app/

Crie a descrição usando o README do projeto:
