...
const SLIDES = [
  {
    title: "ChronosWork",
    desc: `Registro e gestão de atividades de colaboradores. Os cadastros de novas atividades são enviados diretamente para uma planilha, utilizando a Google Sheets API.`,
  ...
  },
  {
    ...
    desc: `Protótipo de uma plataforma de assinatura digital (full stack).`,
